...
- [UniDic](https://clrd.ninjal.ac.jp/unidic/en/), a powerful dictionary for MeCab;
- [J.DepP](https://www.tkl.iis.u-tokyo.ac.jp/~ynaga/jdepp/), the bunsetsu chunker and dependency parser that consumes MeCab+UniDic output;
- [JMdict](https://www.edrdg.org/jmdict/j_jmdict.html), the free open-source Japanese-to-many-languages dictionary;
- [JMdict-Simplified](https://github.com/scriptin/jmdict-simplified), JMdict in JSON;
